"""Execution errata and deterministic execution provenance for Study 3 primary OPE."""
...
PROTOCOL_VERSION = "2.12-study3-deterministic-primary-ope-execution"
ERRATUM_FILE = "study3_primary_ope_execution_erratum_v2_9.json"
RETRY_FILE = "study3_primary_ope_execution_retry_v2_10.json"
DETERMINISTIC_LOCK_FILE = "study3_deterministic_execution_lock_v2_12.json"
...
def run_study3_primary_ope_erratum(
    ...
    *,
    ...
    result["deterministic_execution"] = {
        "file": DETERMINISTIC_LOCK_FILE,
        "coefficient_repro_workflow_run_id": 34054153351,
        "scientific_design_changes": False,
        "threading": "single-thread BLAS/OpenMP",
