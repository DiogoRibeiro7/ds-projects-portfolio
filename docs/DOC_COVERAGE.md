...
- Replaced the documentation style guide and added `docs/CONTRIBUTING_DOCS.md`
...
- Extended `docs/api/statistics.rst` so the autogenerated API reference exposes
  `statistical_methods.advanced_statistical_tests`, keeping the docs site
  synchronized with the refreshed docstrings.
