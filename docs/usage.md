...
`ExperimentAnalyzer` provides additional helpers (power curves, CUPED, CUPAC,
etc.) that use the same docstring-documented API shown in the reference section.

## Next Steps

- Run `python analyze_experiment.py --help` for CLI-driven reporting.
- Browse `docs/api/index.md` for the autogenerated API reference.
- Check `docs/development.md` for testing, linting, and release workflows.
