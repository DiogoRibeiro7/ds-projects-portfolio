...
class TestCachedDataProcessor:
    ...
    def test_cached_outlier_detection(self, processor):
        ...
        # First call
        clean1 = processor.cached_outlier_detection(
            df,
            ['col1', 'col2'],
            method='iqr'
        )
        ...
        # Second call - should use cache
        clean2 = processor.cached_outlier_detection(
            df,
            ['col1', 'col2'],
            method='iqr'
        )
    ...
    def test_cached_statistical_test(self, processor):
        ...
        # First call
        result1 = processor.cached_statistical_test(
            group_a,
            group_b,
            test_type='ttest'
        )
        ...
        # Second call - should use cache
        result2 = processor.cached_statistical_test(
            group_a,
            group_b,
            test_type='ttest'
        )
...
class TestCachedModelTrainer:
    ...
    def test_cached_model_training(self, mock_lr, trainer):
        ...
        # First call
        model1 = trainer.cached_model_training(
            X, y, 'logistic', params
        )

        # Second call - should use cache
        model2 = trainer.cached_model_training(
            X, y, 'logistic', params
        )
...
class TestIntegration:
    ...
    def test_end_to_end_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            df_features = trainer.cached_feature_engineering(
                clean_df,
                feature_config
            )
