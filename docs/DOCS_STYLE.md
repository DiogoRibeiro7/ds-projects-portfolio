...
- Functions invoked by tutorials, CLIs, or tests must provide at least one
  ...
  status in `docs/DOC_COVERAGE.md`.
...
3. Update `docs/DOC_COVERAGE.md` with new modules/symbols and example coverage.
...
- `tools/check_docstring_coverage.py` enforces 100% module/class/function
  ...
  are resolved; this exception is tracked here and in `docs/DOC_COVERAGE.md`.
...
5. Is the new/modified module listed in `docs/DOC_COVERAGE.md`, and were docs
