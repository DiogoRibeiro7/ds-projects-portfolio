...
class TestPredictionAPI:
    ...
    def test_invalid_features(self, client, mock_model_manager):
        ...
        request_data = {"model_name": "test_model", "features": {"invalid": "data"}}
...
class TestModelMetrics:
    ...
    def test_get_model_metrics(self, client):
        ...
        with patch("src.api.ml_api.model_manager") as mock_manager:
            mock_manager.get_metrics = Mock(
                return_value={"accuracy": 0.95, "precision": 0.92, "recall": 0.93}
            )
    ...
    def test_update_model_metrics(self, client):
        ...
        with patch("src.api.ml_api.model_manager") as mock_manager:
            ...
            metrics_data = {"accuracy": 0.96, "precision": 0.94}
...
class TestModelDeployment:
    ...
    def test_deploy_model(self, deployment_manager):
        ...
        deployment_id = deployment_manager.deploy(
            model=model, name="test_deployment", endpoint="/predict/test"
        )
    ...
    def test_canary_deployment(self, deployment_manager):
        ...
        deployment_manager.deploy_canary(model_canary, "prod", traffic_percentage=0.1)
...
class TestAPIRateLimiting:
    ...
    def test_rate_limiting(self, client):
        ...
        for _ in range(15):
            response = client.post(
                "/predict", json={"model_name": "test", "features": {}}
            )
    ...
    def test_rate_limit_headers(self, client):
        ...
        response = client.post("/predict", json={"model_name": "test", "features": {}})
